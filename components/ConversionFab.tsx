    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <a
          ...
          className="whatsapp-fab group flex items-center gap-2 rounded-full shadow-xl transition-all"
          aria-label={fabAriaLabel}
        >
          <svg
            className="whatsapp-fab-icon shrink-0"
            viewBox="0 0 24 24"
            aria-hidden="true"
            fill="currentColor"
          >
          ...
          <span className="hidden md:inline whatsapp-fab-text">WhatsApp</span>
        </a>
      </div>
    </div>
  );
